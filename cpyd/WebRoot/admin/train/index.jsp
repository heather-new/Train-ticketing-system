 ...
 <TABLE width="100%" border=0 align="center" cellPadding=3 cellSpacing=1 class=tablewidth>
		...
		%>
		  <TR  align="center" bgColor=#ffffff>
			...
			<TD id=map><a href="<%=basePath %>admin/train/edit.jsp?method=upTrain&id=<%=list3.get(0).toString()%>">修改</a></TD>
			<TD id=map><a href="<%=basePath %>Job.shtml?method=delTrain&id=<%=list3.get(0).toString()%>">删除</a></TD>
		  </TR>
		<%}}%>
		 </TBODY>
	   </TABLE>
