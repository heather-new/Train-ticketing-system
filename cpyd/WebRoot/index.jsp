...
<TABLE height=300 class=MainTable cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
  <TBODY>
  <TR>
     <TD  align=center><br><br><br><br><br>
		  
 <tr>
	    <td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 50pt;">欢迎使用火车票预定系统</div></td>
	 </tr>
		  </TD>
    </TR>
  </TBODY>
