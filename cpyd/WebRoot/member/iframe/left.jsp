  ...
  <TR>
    <TD vAlign=top align=middle>
      <TABLE  height=24 cellSpacing=0 cellPadding=0 width="100%" border=0>
        ...
        <TR>
          <TD align=middle >
          <a href="<%=basePath %>member/iframe/main.jsp" target="MainFrame">会员中心</a></TD></TR></TBODY></TABLE>
...
<TABLE  bgColor=#eef8fe cellSpacing=0 cellPadding=0 width="90%" align=center border=0>
  ...
  <TABLE width="100%" border="0" align="center"style="cursor:hand" onclick=javascript:expand(1)>
    ...
    <TD background="<%=basePath %>member/images/linkbg1.gif" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A  href="<%=basePath %>" target=_blank>网站首页</A></TD></TR>
    </TABLE>
  ...
  <TR>
    <TD height="31" background="<%=basePath %>member/images/linkbg1.gif">&nbsp;</td>
    <TD background="<%=basePath %>member/images/linkbg1.gif" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<%=basePath %>member/info/my.jsp" target="MainFrame">我的预定</a></TD></TR>
  </TABLE>
